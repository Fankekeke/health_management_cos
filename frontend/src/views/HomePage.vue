<template>
  <div :class="[multipage === true ? 'multi-page':'single-page', 'not-menu-page', 'home-page']" style="background-color: #f6fff6; border: none">
    ...
    <a-row :gutter="20" style="width: 66%;margin: 0 auto;margin-bottom: 15px">
      ...
      <a-col :span="6">
        <a-card hoverable :loading="loading" :bordered="false" title="健康百科" style="height: 550px;overflow: auto">
